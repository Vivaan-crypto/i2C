...
public class ColorSensorRed extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while(opModeIsActive()) {
            ...
            if(BlueL < 0 && GreenL < 0 && RedL <0 && BlueR < 0 && GreenR < 0 && RedR <0) { //Change if loop's "if" condition if needed
                telemetry.addData("Status", "Program Starting");
                telemetry.update();
                sleep(3000);
                fr.setPower(0.5);
                ...
                bl.setPower(0.5);
                //Move to Spike tape zone to place pixel
                sleep(1000);//Change the time as needed
                fr.setPower(0.5);
                fl.setPower(0.5);
                br.setPower(0.5);
                bl.setPower(0.5);
                ...
                //Change # as needed but make sure claw drops pixel
                //Drops pixel on spike tape
                sleep(250); //Change the time as needed
                fr.setPower(-0.5);
                fl.setPower(-0.5);
                br.setPower(-0.5);
                bl.setPower(-0.5);
