...
and then drive to backboard and put yellow pixel over there.  Then for Auto 3 & 4  make robot put
    both pixels down on he line with team prop!*/
            ...
            if(ColorSensor1.blue()> 100) { /*Change from what it is right now to the Color sensor Detecting Team Prop on Right */
                //Turn right
                fl.setPower(0.5);
                fr.setPower(0.5);
                br.setPower(0.5);
            ...
            if(ColorSensor2.blue() > 100){ /*Change from what it is right now to the Color sensor Detecting Team Prop on the Left  */
                //Turn Left
                fl.setPower(-0.5);
                fr.setPower(-0.5);
                br.setPower(-0.5);
...
//Claw2.setPosition(1);
            ...
            if(ColorSensor3.blue() > 100) {/*Change from what it is right now to the Color sensor Detecting Team Prop in front  */
                fl.setPower(0.5);
                fr.setPower(-0.5);
                br.setPower(-0.5);
                bl.setPower(-0.5);
